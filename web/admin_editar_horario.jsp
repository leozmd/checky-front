...
<body>
    ...
    <main class="d-lg-flex justify-content-lg-center align-items-lg-center" style="height: 100%;">
        <div class="d-lg-flex flex-column justify-content-lg-center align-items-lg-center" style="width: 90%;font-family: 'Red Hat Text', sans-serif;">
            ...
            <form style="width: 70%;margin-top: 5%;"><label class="form-label" for="estado">Día del horario</label>
                <div>
                    <div class="d-lg-flex justify-content-lg-center align-items-lg-center" style="height: 50%;width: 80%;">
                        ...
                        <div class="form-check" style="margin: aut;"><input class="form-check-input" type="radio" id="formCheck-6" value="Miercoles"><label class="form-check-label" for="formCheck-6">Miércoles</label></div>
                    ...
                    <div class="d-lg-flex align-items-center justify-content-lg-center align-items-lg-center" style="height: 50%;width: 80%;">
                        ...
                        <div class="form-check" style="margin: auto;"><input class="form-check-input" type="radio" id="formCheck-3" value="Sabado"><label class="form-check-label" for="formCheck-3">Sábado</label></div>

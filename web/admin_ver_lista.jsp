...
<body style="background: #F3EFF5;width: 100%;height: 100%;">
    ...
    <div class="container d-lg-flex flex-column justify-content-lg-center align-items-lg-center" style="width: 100%;height: 100%;">
        <h1 style="height: auto;margin-bottom: 4%;color: #3F7D20;font-family: 'Red Hat Display', sans-serif;font-weight: bold;">Pase de lista</h1>
        <h1 style="height: auto;font-family: 'Space Mono', monospace;">2Z5S6GlI34</h1>
        <h3 style="height: auto;margin-top: 4%;font-family: 'Red Hat Text', sans-serif;">Proporciona este cÃ³digo a los estudiantes</h3>
        <h3 style="margin-top: 7%;text-align: center;font-family: 'Red Hat Text', sans-serif;color: #3a7728;">Estudiantes que han registrado asistencia:</h3>
        <div class="table-responsive text-center mx-auto" style="width: 98%;margin-top: 16px;border-radius: 6px;border: 2px solid var(--bs-green);border-bottom-color: #3F7D20;">
            <table class="table">
                ...
                <tbody>
                    <tr style="background: #d2d2d2;">
                        <td>Pedro JoaquÃ­n Arias Martinez</td>
                        <td>Masculino</td>
                        <td>2020090376</td>
                        <td>Inscrito</td>
                        <td>12-05-2022 18:03:42</td>
                    </tr>
                </tbody>
            </table>
        </div>

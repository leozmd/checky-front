...
<body>
    ...
    <main class="d-lg-flex justify-content-lg-center align-items-lg-center" style="height: 100%;">
        <div class="d-lg-flex flex-column justify-content-lg-center align-items-lg-center" style="width: 90%;">
            <h1 style="margin-top: 1%;font-family: 'Red Hat Display', sans-serif;font-weight: bold;color: #3F7D20;margin-bottom: 0;">Grupos</h1><button class="btn btn-primary border rounded-pill" type="submit" style="font-family: 'Red Hat Text', sans-serif;background: #3F7D20;border-color: #3F7D20;width: 210px;height: 71px;font-size: 24px;border-radius: 100;color: #F3EFF5;margin-top: 1%;">Nuevo grupo</button>
            <div class="table-responsive text-center d-lg-flex mx-auto justify-content-lg-center" style="width: 100%;margin-top: 16px;border-radius: 6px;border: 2px solid var(--bs-green);border-bottom-color: #3F7D20;">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        List<Grupo>list = dao.listar();
                        Iterator<Grupo>iter = list.iterator();
                        Grupo gru = null;
                        while (iter.hasNext()){
                            gru = iter.next();
                        ...
                        <tr style="background: #d2d2d2;">
                            <td><% gru.getTipoGrupo(); %></td>
                            <td><% gru.getNumClases(); %></td>
                            <td>

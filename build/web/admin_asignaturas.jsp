...
<body>
    ...
    <main class="d-lg-flex justify-content-lg-center align-items-lg-center" style="height: 100%;">
        <div class="d-lg-flex flex-column justify-content-lg-center align-items-lg-center" style="width: 90%;">
            <h1 style="margin-top: 1%;font-family: 'Red Hat Display', sans-serif;font-weight: bold;color: #3F7D20;margin-bottom: 0;">Asignaturas</h1><a><button class="btn btn-primary border rounded-pill" type="button" style="font-family: 'Red Hat Text', sans-serif;background: #3F7D20;border-color: #3F7D20;width: auto;height: 71px;font-size: 24px;border-radius: 100;color: #F3EFF5;margin-top: 1%;">Nueva asignatura</button></a>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr style="background: #d2d2d2;">
                            ...
                            <td><% asig.getClav(); %></td>
                            <td><% asig.getNumClases(); %></td>
                            <td>
                                <a>
                                    <button class="btn btn-warning border-dark" type="submit" style="margin-right: 2%;">Editar</button>
                                </a>
                                <a>
                                    <button class="btn btn-danger border-light" type="submit">Eliminar</button>
                                </a>
                            </td>
                        </tr>
                    </tbody>

...
<body>
    ...
    <main class="d-lg-flex justify-content-lg-center align-items-lg-center" style="height: 100%;">
        <div class="d-lg-flex flex-column justify-content-lg-center align-items-lg-center" style="width: 90%;font-family: 'Red Hat Text', sans-serif;">
            <h1 style="margin-top: 2%;font-family: 'Red Hat Display', sans-serif;font-weight: bold;color: #3F7D20;margin-bottom: 0;">Editar horario</h1>
            <form style="width: 70%;margin-top: 5%;"><label class="form-label" for="estado">DÃ­a del horario</label>
                <div>
                    <div class="d-lg-flex justify-content-lg-center align-items-lg-center" style="height: 50%;width: 80%;">
                        <div class="form-check" style="margin: auto;"><input class="form-check-input" type="radio" id="formCheck-1" value="Lunes"><label class="form-check-label" for="formCheck-1">Lunes</label></div>
                        <div class="form-check" style="margin: auto;"><input class="form-check-input" type="radio" id="formCheck-7" value="Martes"><label class="form-check-label" for="formCheck-7">Martes</label></div>
                        <div class="form-check" style="margin: aut;"><input class="form-check-input" type="radio" id="formCheck-6" value="Miercoles"><label class="form-check-label" for="formCheck-6">MiÃ©rcoles</label></div>
                        <div class="form-check" style="margin: auto;"><input class="form-check-input" type="radio" id="formCheck-5" value="Jueves"><label class="form-check-label" for="formCheck-5">Jueves</label></div>
                    </div>
                    <div class="d-lg-flex align-items-center justify-content-lg-center align-items-lg-center" style="height: 50%;width: 80%;">
                        <div class="form-check" style="margin: auto;"><input class="form-check-input" type="radio" id="formCheck-4" value="Viernes"><label class="form-check-label" for="formCheck-4">Viernes</label></div>
                        <div class="form-check" style="margin: auto;"><input class="form-check-input" type="radio" id="formCheck-3" value="Sabado"><label class="form-check-label" for="formCheck-3">SÃ¡bado</label></div>
                        <div class="form-check" style="height: auto;"><input class="form-check-input" type="radio" id="formCheck-2" value="Domingo"><label class="form-check-label" for="formCheck-2">Domingo</label></div>
                    </div>
                </div><label class="form-label" style="margin-top: 3%;" for="clave">Inicio del horario</label><input class="form-control" type="time"><label class="form-label" style="margin-top: 3%;" for="clave">Fin del horario</label><input class="form-control" type="time"><button class="btn btn-primary border rounded-pill" type="button" style="font-family: 'Red Hat Text', sans-serif;background: #3F7D20;border-color: #3F7D20;width: 210px;height: 71px;font-size: 24px;border-radius: 100;color: #F3EFF5;margin-top: 8%;">Guardar</button>
            </form>
        </div>
    </main>

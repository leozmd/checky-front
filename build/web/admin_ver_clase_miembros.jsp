...
<body>
    ...
    <div class="container">
        <h1 style="margin-top: 2%;text-align: center;font-family: 'Red Hat Display', sans-serif;font-weight: bold;color: #3F7D20;">Miembros de la clase</h1>
        <h3 style="margin-top: 2%;text-align: center;font-family: 'Red Hat Text', sans-serif;">Docentes</h3>
            ...
            <table class="table">
                ...
                <tbody>
                    <tr style="background: #d2d2d2;">
                        ...
                        <td>Masculino</td>
                        <td>
                            <form><input class="form-control d-none" type="text" readonly=""><button class="btn btn-danger" type="submit">Eliminar</button></form>
                        </td>
                    </tr>
                </tbody>
            </table>
        </div>
        <h3 style="margin-top: 4%;text-align: center;font-family: 'Red Hat Text', sans-serif;">Estudiantes</h3>
        <div class="table-responsive text-center mx-auto" style="width: 84%;margin-top: 16px;border-radius: 6px;border: 2px solid var(--bs-green) ;border-bottom-color: #3F7D20;">
            <table class="table">
                <thead style="border-bottom-width: 2px;border-bottom-color: #3F7D20;">
                    <tr style="background: #3F7D20;border-bottom-color: #3F7D20;color: rgb(222,226,230);font-family: 'Red Hat Display', sans-serif;">

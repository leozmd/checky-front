...
<body>
    ...
    <main class="d-lg-flex justify-content-lg-center align-items-lg-center" style="height: 100%;">
        <div class="d-lg-flex flex-column justify-content-lg-center align-items-lg-center" style="width: 90%;font-family: 'Red Hat Text', sans-serif;">
            <h1 style="margin-top: 2%;font-family: 'Red Hat Display', sans-serif;font-weight: bold;color: #3F7D20;margin-bottom: 0;">Editar clase</h1>
            <form style="width: 70%;margin-top: 5%;"><label class="form-label" for="asignatura">Asignatura</label><select class="form-select" name="asignatura">
                    <optgroup label="Seleccionar asignatura">
                        <option value="" selected="">Asignatura</option>
                    </optgroup>
                </select><label class="form-label" for="asignatura" style="margin-top: 3%;">Carrera</label><select class="form-select" name="asignatura">
                    <optgroup label="Seleccionar carrera">
                        <option value="" selected="">Carrera</option>
                    </optgroup>
                </select><label class="form-label" for="asignatura" style="margin-top: 3%;">Turno</label><select class="form-select" name="turno">
                    <optgroup label="Seleccionar turno">
                        <option value="" selected="">Turno</option>
                    </optgroup>
                </select><label class="form-label" for="grupo" style="margin-top: 3%;">Grupo</label><select class="form-select" name="grupo">
                    <optgroup label="Seleccionar grupo">
                        <option value="" selected="">Grupo</option>
                    </optgroup>
                </select><label class="form-label" for="grado" style="margin-top: 3%;">Grado</label><select class="form-select" name="grado">
                    <optgroup label="Seleccionar grado">
                        <option value="" selected="">Grado</option>
                    </optgroup>
                </select><button class="btn btn-primary border rounded-pill" type="button" style="font-family: 'Red Hat Text', sans-serif;background: #3F7D20;border-color: #3F7D20;width: 210px;height: 71px;font-size: 24px;border-radius: 100;color: #F3EFF5;margin-top: 8%;">Guardar</button></form>
        </div>
    </main>

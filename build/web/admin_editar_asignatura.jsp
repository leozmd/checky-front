...
<body>
    ...
    <main class="d-lg-flex justify-content-lg-center align-items-lg-center" style="height: 100%;">
        <div class="d-lg-flex flex-column justify-content-lg-center align-items-lg-center" style="width: 90%;font-family: 'Red Hat Text', sans-serif;">
            <h1 style="margin-top: 2%;font-family: 'Red Hat Display', sans-serif;font-weight: bold;color: #3F7D20;margin-bottom: 0;">Editar asignatura</h1>
            <form style="width: 70%;margin-top: 5%;"><label class="form-label" for="asignatura">Nombre de la asignatura</label><input class="form-control" type="text" name="asignatura" placeholder="Ingresa el nombre de la asignatura"><label class="form-label" style="margin-top: 3%;" for="clave">Clave de la asignatura</label><input class="form-control" type="text" name="clave" placeholder="Ingresa la clave de la asignatura"><button class="btn btn-primary border rounded-pill" type="button" style="font-family: 'Red Hat Text', sans-serif;background: #3F7D20;border-color: #3F7D20;width: 210px;height: 71px;font-size: 24px;border-radius: 100;color: #F3EFF5;margin-top: 8%;">Crear</button></form>
        </div>
    </main>
